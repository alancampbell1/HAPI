...
const nexmo = new Nexmo({
	apiKey: 'xxxxxxxxx',                //You will need to apply your own apikey and apisecret
	apiSecret: 'xxxxxxx'
}, {debug: true});
...
app.post('/send', (req, res) => {
  ...
  `;
    ...
    let transporter = nodemailer.createTransport({
      ...
      port: 25,
      auth: {
        user: 'xxxxxxxxxxxx@gmail.com',		//You will need to add your own email address here
        pass: 'xxxxxxxxxxxxxxx'						//You will need to provide your password in order for nodemailer
